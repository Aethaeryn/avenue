...
def forums():
    ...
    return render_template('forum.html', style='night', main_title=heading, posts=post_list, sidebar=navbar, title=page_title, author=post_author, thread_title=thread_title)
